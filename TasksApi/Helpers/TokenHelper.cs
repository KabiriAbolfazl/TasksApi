...
namespace TasksApi.Helpers
{
    public class TokenHelper
    {
        ...
        {
            var tokenHandlare = new JwtSecurityTokenHandler();
            ...
            var securityToken = tokenHandlare.CreateToken(tokenDescriptor);
            return await Task.Run(() => tokenHandlare.WriteToken(securityToken));
        }
